...
local light_theme = {
  bg_base = greys["hinted-grey-15"],
  bg_body = colors.white,
  bg_alt = greys["hinted-grey-14"],
  bg_alt2 = greys["hinted-grey-13"],
  bg_accent = purples["twitch-purple-8"],
  bg_accent_alt = purples["twitch-purple-7"],
  bg_accent_alt2 = purples["twitch-purple-11"],
  bg_accent_alt3 = purples["twitch-purple-12"],
  bg_accent_alt4 = purples["twitch-purple-13"],
  ...
  brand_muted = colors.twitch_purple.lighten(75),
  brand_contrast = colors.twitch_purple.darken(75),
...
local theme = lush(function()
  return {
    ...
    Pmenu { TextAlt, bg = selected_theme.bg_base }, -- Popup menu: normal item.
    ...
    CocHighlightText { bg = selected_theme.brand_muted },
    ...
    TSFunction { TextAlt, gui = "bold" }, -- function name (also: methods for classes)
    ...
    Type { TextAlt, gui = "bold" }, -- (preferred) int, long, char, etc.
    ...
    -- TSField              { fg = selected_theme.text_base };    -- For fields.
    -- TSFloat              { };    -- For floats.
    ...
    TSPunctDelimiter { fg = TextAlt2.fg.mix(BrandText.fg, 50) }, -- For delimiters ie: `.`
